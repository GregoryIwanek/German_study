...
#include "../../German_Study/mybutton.h"
...
QT_MOC_LITERAL(3, 18, 10), // "hoverEvent"
QT_MOC_LITERAL(4, 29, 4) // "quit"

    },
    "MyButton\0clicked\0\0hoverEvent\0quit"
};
...
void MyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyButton::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyButton::hoverEvent)) {
                *result = 1;
                return;
            }
        }
...
void *MyButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsRectItem"))
        return static_cast< QGraphicsRectItem*>(const_cast< MyButton*>(this));
